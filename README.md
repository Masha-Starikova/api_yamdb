...
```
git clone git@github.com:Masha-Starikova/api_yamdb.git
```
...
**https://github.com/Masha-Starikova.** Тимлид. Отзывы, комментарии, рейтинг произведений. 

**https://github.com/Sekhniev.** Произведения, категории, жанры, импорт csv-файлов.

**https://github.com/Elmiraz-ship-it.** Регистрация и авторизация, управление пользователями, права доступа.
